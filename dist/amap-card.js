...
var editor$1 = {
	...
	history: {
		showHistory: "Show History Track",
		hours: "History Duration (Hours)",
...
let AMapCardEditor = class AMapCardEditor extends i {
    constructor() {
        super(...arguments);
...
var coordtransform$1 = {exports: {}};

/**
 * Created by Wandergis on 2015/7/8.
 * 提供了百度坐标（BD09）、国测局坐标（火星坐标，GCJ02）、和WGS84坐标系之间的转换
 */
var coordtransform = coordtransform$1.exports;

var hasRequiredCoordtransform;

function requireCoordtransform () {
	if (hasRequiredCoordtransform) return coordtransform$1.exports;
	hasRequiredCoordtransform = 1;
	(function (module) {
		//UMD魔法代码
		...
		(function (root, factory) {
		  ...
		  var transformlat = function transformlat(lng, lat) {
		    var lat = +lat;
		    var lng = +lng;
		    var ret = -100 + 2.0 * lng + 3.0 * lat + 0.2 * lat * lat + 0.1 * lng * lat + 0.2 * Math.sqrt(Math.abs(lng));
	...
	return coordtransform$1.exports;
}

var coordtransformExports = requireCoordtransform();
...
let AMapCard = class AMapCard extends i {
    ...
    async _fetchHistoryData(entityId, startTime, endTime) {
    ...
    _processHistoryData(historyData) {
        ...
        for (const state of historyData) {
            if (state.attributes && state.attributes.latitude && state.attributes.longitude) {
                const [gcjLng, gcjLat] = coordtransformExports.wgs84togcj02(state.attributes.longitude, state.attributes.latitude);
                if (gcjLng && gcjLat) {
    ...
    _createEntityCircle(AMap, stateObj, entityId) {
        const [gcjLng, gcjLat] = coordtransformExports.wgs84togcj02(stateObj.attributes.longitude, stateObj.attributes.latitude);
